...
{/*3->confiure store a redux tolkit function which takes persisted reducer(basiaclly store takes reducers functions but in this case we are using oersist redux so 
  we are takin the reducer function which is persisted 
 ) and other */}
...
//providin store to the whole app 
